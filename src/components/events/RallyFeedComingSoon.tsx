const MOCK_CARDS = [
  {
    title: 'Skybar Rooftop',
    meta: 'Live Now · 247 going',
    img: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=400&q=60',
  },
  {
    title: 'Warehouse Party',
    meta: 'Tonight 11PM · 89 going',
    img: 'https://images.unsplash.com/photo-1571266028243-d220c6a7b48e?w=400&q=60',
  },
  {
    title: 'Sundown Sessions',
    meta: 'Saturday · 156 going',
    img: 'https://images.unsplash.com/photo-1506157786151-b8491531f063?w=400&q=60',
  },
  {
    title: 'The Local',
    meta: 'Tonight · 42 going',
    img: 'https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400&q=60',
  },
  {
    title: 'Neon Nights',
    meta: 'Friday 10PM · 312 going',
    img: 'https://images.unsplash.com/photo-1545128485-c400e7702796?w=400&q=60',
  },
  {
    title: 'Rooftop Reset',
    meta: 'Sunday Brunch · 78 going',
    img: 'https://images.unsplash.com/photo-1530023367847-a683933f4172?w=400&q=60',
  },
  {
    title: 'Basement Sessions',
    meta: 'Tonight 9PM · 64 going',
    img: 'https://images.unsplash.com/photo-1574391884720-bbc049ec09ad?w=400&q=60',
  },
  {
    title: 'Golden Hour Garden',
    meta: 'Saturday 6PM · 198 going',
    img: 'https://images.unsplash.com/photo-1533777324565-a040eb52facd?w=400&q=60',
  },
  {
    title: 'Lantern Loft',
    meta: 'Friday 11PM · 121 going',
    img: 'https://images.unsplash.com/photo-1519214605650-76a613ee3245?w=400&q=60',
  },
  {
    title: 'Pier 7 Afters',
    meta: 'Sunday 2AM · 53 going',
    img: 'https://images.unsplash.com/photo-1502635385003-ee1e6a1a742d?w=400&q=60',
  },
];

function MockCard({ title, meta, img }: { title: string; meta: string; img: string }) {
  return (
...
export function RallyFeedComingSoon() {
  return (
    <div className="relative min-h-[100dvh] overflow-hidden bg-background">
      ...
      >
        <div
          className="px-4 will-change-transform"
          style={{
            animation: 'rally-feed-scroll 60s linear infinite',
          }}
        >
      ...
      {/* Top + bottom theme-aware fades */}
      <div
        className="pointer-events-none absolute inset-x-0 top-0 h-48 bg-gradient-to-b from-background via-background/80 to-transparent"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-56 bg-gradient-to-t from-background via-background/80 to-transparent"
        aria-hidden
      />
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center px-6">
        ...
        >
          ...
          {/* Subhead */}
          <p className="mt-3 text-sm text-foreground/65 font-montserrat">
