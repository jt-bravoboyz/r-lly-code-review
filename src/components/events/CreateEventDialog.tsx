      ...
      <DialogContent ref={scrollContainerRef} className="max-h-[90vh] overflow-y-auto scrollbar-hide p-0 border-0 bg-transparent shadow-none [&>button]:hidden">
        <div className="rally-create-glow-wrapper">
          <div className="rally-create-inner p-6 space-y-5">
            ...
            <nav className="flex items-center justify-center gap-3 text-[10px] font-montserrat uppercase tracking-[0.2em] sticky top-0 z-10 py-2 <nav className="flex items-center justify-center gap-3 text-[10px] font-montserrat uppercase tracking-[0.2em] sticky top-0 z-10 py-2 bg-background/95 backdrop-blur-md -mx-6 px-6"> backdrop-blur-md -mx-6 px-6">
