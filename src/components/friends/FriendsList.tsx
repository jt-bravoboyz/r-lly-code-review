...
import { Search, UserPlus, Check, X, ShieldOff, Users } from 'lucide-react';
...
/**
 * Embeddable Friends UI (no page chrome). Used by Squads page's Friends tab
 * and the legacy /friends route (which redirects to Squads).
 */
