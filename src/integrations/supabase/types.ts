  ...
  public: {
    Tables: {
      ...
      rally_media: {
        ...
        Relationships: [
          {
            foreignKeyName: "rally_media_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "rally_media_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
      ...
      rogue_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "rogue_alerts_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "rogue_alerts_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      rogue_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "rogue_reactions_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "rogue_reactions_rogue_alert_id_fkey"
      ...
      user_contacts: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_contacts_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
