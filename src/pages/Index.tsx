      ...
      <main className="px-4 py-6 space-y-8 relative z-10">
        ...
        <section className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <CreateEventDialog
              trigger={
                <Card data-tutorial="create-event-button" className="group glass-elevated rounded-2xl overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:border-primary/20 cursor-pointer">
