...
export default function UpcomingRallies() {
        ...
        {isLoading ? (
          ...
          <Card className="glass-elevated rounded-2xl">
            <CardContent className="p-8 text-center">
              ...
              <h2 className="font-bold text-lg mb-2 font-montserrat">No R@llies on deck</h2>
              <p className="text-sm text-muted-foreground font-montserrat mb-6">Start one and rally your squad.</p>
              <QuickRallyDialog />
            </CardContent>
          </Card>
        ) : (
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground font-montserrat px-1">
              {upcoming.length} R@ll{upcoming.length === 1 ? 'y' : 'ies'} on the calendar — tap any to dial in.
            </p>
            {upcoming.map((event) => (
