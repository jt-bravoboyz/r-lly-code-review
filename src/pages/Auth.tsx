...
export default function Auth() {
  ...
  useEffect(() => {
    if (googleScriptLoaded && googleButtonRef.current && !isForgotPassword) {
      // Check if policies are accepted before rendering
      const policiesAccepted = localStorage.getItem('rally-policies-accepted') === 'true';
      if (policiesAccepted) {
        renderGoogleButton(googleButtonRef.current);
      }
    }
  }, [googleScriptLoaded, renderGoogleButton, isForgotPassword, showPolicyDialog]);
  ...
  const handleGoogleSignInClick = () => {
    ...
    // If policies accepted, the Google button handles the sign-in flow
  };
  ...
  const handlePolicyAccepted = () => {
    ...
    if (pendingAuthAction === 'signup') {
      ...
      // Re-render the Google button after policy acceptance, then click it
      setTimeout(() => {
            ...
            <>
              ...
              {googleConfigured && (
                <div className="w-full">
                  ...
                  {localStorage.getItem('rally-policies-accepted') === 'true' ? (
                    <div 
                      ref={googleButtonRef}
