...
const SITE_NAME = 'rallyboyz'
const LOGO_URL =
  'https://lovzfxppnxictkvymyot.supabase.co/storage/v1/object/public/email-assets/logo.svg'

interface RallyInviteProps {
  inviterName?: string
  rallyUrl?: string
}

const RallyInviteEmail = ({
  inviterName = 'Someone',
  rallyUrl = 'https://rlly.cloud',
}: RallyInviteProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You're being summoned. The night is moving. 🟠</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO_URL} alt="R@lly" width="60" height="60" style={logoStyle} />
        <Heading style={h1}>You're being summoned.</Heading>
        <Text style={text}>
          <strong>{inviterName}</strong> just started a R@lly and you're on the list.
        </Text>
        <Text style={text}>
          The night is moving—don't get left behind.
        </Text>
        <Button style={button} href={rallyUrl}>
          Join the R@lly
        </Button>
...
export const template = {
  component: RallyInviteEmail,
  subject: "You're being summoned.",
  displayName: 'R@lly Invite',
  previewData: {
    inviterName: 'Joey',
    rallyUrl: 'https://rlly.cloud/r/sample',
  },
